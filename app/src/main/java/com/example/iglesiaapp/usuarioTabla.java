...
public class usuarioTabla extends AppCompatActivity {
    ...
    private String[]header={"ID","Nombre","Correo","Edad"};
    ...
    private ArrayList<String[]> obtenerUsuarios(){
        ...
        for (UsuarioDato usuario:usuarioDatoList){
            filas.add(new String[]{String.valueOf(usuario.getId()),usuario.getNombre(),usuario.getEmail(),String.valueOf(usuario.getEdad())});
        }
